# Generated by Django 3.2 on 2024-11-15 11:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(blank=True, help_text='Группы к которым принадлежит пользовательПользователь получит все разрешения к каждой из групп.', related_name='custom_user_groups', to='auth.Group', verbose_name='groups')),
